...
public partial class TimeContext {
    ...
    public TimeEntity rollbackEntity { get { return GetGroup(TimeMatcher.Rollback).GetSingleEntity(); } }
...
public partial class TimeEntity {
    ...
    public bool isRollback {
        get { return HasComponent(TimeComponentsLookup.Rollback); }
        set {
            if (value != isRollback) {
                var index = TimeComponentsLookup.Rollback;
                if (value) {
...
public sealed partial class TimeMatcher {
    ...
    static Entitas.IMatcher<TimeEntity> _matcherRollback;

    public static Entitas.IMatcher<TimeEntity> Rollback {
        get {
            if (_matcherRollback == null) {
                var matcher = (Entitas.Matcher<TimeEntity>)Entitas.Matcher<TimeEntity>.AllOf(TimeComponentsLookup.Rollback);

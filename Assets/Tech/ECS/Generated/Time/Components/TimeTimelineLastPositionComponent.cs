...
public partial class TimeContext {
    ...
    public TimeEntity SetTimelineLastPosition(Common.TransformInfo newValue) {
    ...
    public void ReplaceTimelineLastPosition(Common.TransformInfo newValue) {
...
public partial class TimeEntity {
    ...
    public void AddTimelineLastPosition(Common.TransformInfo newValue) {

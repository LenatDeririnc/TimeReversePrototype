...
public partial class TimeContext {
    ...
    public TimeEntity timeEntity { get { return GetGroup(TimeMatcher.Time).GetSingleEntity(); } }
    public TimeComponent time { get { return timeEntity.time; } }
    public bool hasTime { get { return timeEntity != null; } }

    public TimeEntity SetTime(float newValue) {
        if (hasTime) {
...
public partial class TimeEntity {
    ...
    public TimeComponent time { get { return (TimeComponent)GetComponent(TimeComponentsLookup.Time); } }
    public bool hasTime { get { return HasComponent(TimeComponentsLookup.Time); } }

    public void AddTime(float newValue) {
        var index = TimeComponentsLookup.Time;
    ...
    public void RemoveTime() {
        RemoveComponent(TimeComponentsLookup.Time);
    }
}
...
public sealed partial class TimeMatcher {
    ...
    static Entitas.IMatcher<TimeEntity> _matcherTime;

    public static Entitas.IMatcher<TimeEntity> Time {
        get {
            if (_matcherTime == null) {
                var matcher = (Entitas.Matcher<TimeEntity>)Entitas.Matcher<TimeEntity>.AllOf(TimeComponentsLookup.Time);
